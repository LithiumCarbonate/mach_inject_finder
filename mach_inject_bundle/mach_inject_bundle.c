		...
		pid_t		pid )
{
	...
	if( !err ) {
        ...
        CFURLRef frameworkURL = CFURLCreateCopyAppendingPathComponent(kCFAllocatorDefault,
                                                                      mainbundleURL,
                                                                      CFSTR("Contents/Frameworks/mach_inject_bundle.framework"),
                                                                      true);
        CFRelease(mainbundleURL);
        frameworkBundle = CFBundleCreate(kCFAllocatorDefault, frameworkURL);
